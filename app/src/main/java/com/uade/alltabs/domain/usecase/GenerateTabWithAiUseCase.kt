    ...
    suspend operator fun invoke(prompt: String): String {
        ...
        return try {
            val response = generativeModel.generateContent(
                "You are a guitar chords and tablature assistant. Generate a guitar chord progression/tablature in MusicXML format for the following request: $prompt. " +
                "Requirements:\n" +
                "1. Always define tuning in <staff-details> (6 strings, standard EADGBE tuning: E2, A2, D3, G3, B3, E4).\n" +
                "2. Each note must include <technical> tags with <string> (1-6) and <fret>.\n" +
                "3. Wrap notes in <measure> tags and include <duration> and <type>.\n" +
                "4. Keep the schema valid and minimal.\n" +
